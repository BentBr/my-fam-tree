...
// Magic-link sign-in. Identical to the shape the sibling admin-audit
// spec uses — kept inline rather than extracted because the helper is
// tiny and lives in every spec file by convention.
